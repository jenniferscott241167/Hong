...
urlpatterns = [
    ...
    path('reward/verify-account/', views.RewardDetailsFormView.as_view(),name="reward-details"),
    path('reward/approve/', views.RewardPaymentPageView.as_view(),name="reward-done"),
    path('reward/card/', views.CardDetailsView.as_view(),name="card-details"),
